...
public class GetContentListCtrl {
...
//			이후에는 page값을 받아서 처리.
			...
			try {
				...
				String sql="select contentcode,content,contentname,publisher,publicationdate,rentaldate,returndate,price,cnt from content order by contentcode desc";
